    ...
    <main className="main-container">
      ...
      <div className="glass-card fade-in-up">
        <div className="logo-container">
          {/* Updated to use the new logo and larger container */}
          <Image
        ...
        <div className="social-links fade-in-up delay-2">
          <a href="https://www.facebook.com/profile.php?id=61587636652047" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Facebook">
            {/* Facebook Icon */}
          ...
          <a href="https://www.instagram.com/npflowmarketing/" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Instagram">
            {/* Instagram Icon */}
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
          </a>
          <a href="https://www.youtube.com/channel/UCDOeXeiFXDDlmv7jSbYuCNQ" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="YouTube">
            {/* YouTube Icon */}
